...
namespace Code_Katas_Tests
{
    public class Test_GetIsPallindrome
    {
        ...
        {
            Assert.That(CodeKatas.GetIsPalindrome(input), Is.EqualTo(expected));
        }
        ...
        {
            Assert.That(CodeKatas.GetIsPalindrome("a"), Is.EqualTo(true));
        }

        [Test]
        public void GivenStringWithZeroCharacters_GetIsPalindrome_ReturnsResult()
        {
            Assert.That(CodeKatas.GetIsPalindrome(""), Is.EqualTo(true));
        }
    }
}